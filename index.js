...
function aux_write_stack_trace_21151(f_21153) {
	...
	var result_21154 = [null];
		...
		L6: do {
			var j_21421 = 0;
			var colontmp__249625 = 0;
			colontmp__249625 = (i_21164 - 1);
			var res_249626 = colontmp__249625;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_249626)) break L8;
						j_21421 = res_249626;
...
function new_seq_199212(len_199215) {
	...
	framePtr = F;
		F.line = 994;
		result_199217 = new Array(len_199215); for (var i=0;i<len_199215;++i) {result_199217[i]={k: 0, parent: null, current: null, n: null};}	framePtr = F.prev;
...
function new_seq_199249(len_199252) {
	...
	framePtr = F;
		F.line = 994;
		result_199254 = new Array(len_199252); for (var i=0;i<len_199252;++i) {result_199254[i]={parent: null, newChild: null, pos: 0};}	framePtr = F.prev;
					...
					function HEX3Aanonymous_189833(ev_189835) {
							...
							function wrapper_189836() {
								...
								framePtr = F;
									...
									F.line = 74;
									failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(74, 10) `action != nil` "));
									}
...
function apply_events_190086(n_190088) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_190102 = 0;
			F.line = 2716;
			var colontmp__249669 = 0;
			F.line = 128;
			colontmp__249669 = (n_190088.events != null ? n_190088.events.length : 0);
			F.line = 2717;
			var i_249670 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249670 < colontmp__249669)) break L3;
						F.line = 128;
						i_190102 = i_249670;
						F.line = 129;
...
function apply_style_58025(n_58027, s_58028) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_58221 = 0;
			F.line = 2653;
			var colontmp__249681 = 0;
			F.line = 300;
			colontmp__249681 = subInt(s_58028.length, 1);
			F.line = 2669;
			var res_249682 = 0;
			L2: do {
				F.line = 2670;
					L3: while (true) {
					if (!(res_249682 <= colontmp__249681)) break L3;
						F.line = 300;
						i_58221 = res_249682;
						F.line = 301;
						n_58027.style[s_58028[i_58221]] = s_58028[addInt(i_58221, 1)];
						F.line = 2672;
						res_249682 = addInt(res_249682, 2);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function vnode_to_dom_190167(n_190169, kxi_190170) {
	...
	BeforeRet: do {
		...
		F.line = 154;
		failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(154, 12) `result != nil` "));
		}
		...
		F.line = 161;
		failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(161, 12) `x.renderImpl != nil` "));
		}
		...
		if (!(!((x_190422.expanded == null)))) {
		F.line = 165;
		failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(165, 12) `x.expanded != nil` "));
		}
		...
		break BeforeRet;
			...
			L1: do {
				...
				L2: do {
					...
					var i_249639 = 0;
					F.line = 2716;
					var colontmp__249640 = 0;
					F.line = 282;
					colontmp__249640 = (n_190169.kids != null ? n_190169.kids.length : 0);
					F.line = 2717;
					var i_249641 = 0;
					L3: do {
						F.line = 2718;
							L4: while (true) {
							if (!(i_249641 < colontmp__249640)) break L4;
								F.line = 282;
								i_249639 = i_249641;
								F.line = 172;
								k_190831 = n_190169.kids[chckIndx(i_249639, 0, n_190169.kids.length+0-1)-0];
								F.line = 173;
								result_190171.appendChild(vnode_to_dom_190167(k_190831, kxi_190170));
								F.line = 2720;
								i_249641 = addInt(i_249641, 1);
							}
					} while(false);
				} while(false);
			} while(false);
		...
		L5: do {
			...
			L6: do {
				...
				var i_249652 = 0;
				F.line = 2653;
				var colontmp__249653 = 0;
				F.line = 285;
				colontmp__249653 = subInt((n_190169.attrs != null ? n_190169.attrs.length : 0), 2);
				F.line = 2669;
				var res_249654 = 0;
				L7: do {
					F.line = 2670;
						L8: while (true) {
						if (!(res_249654 <= colontmp__249653)) break L8;
							F.line = 285;
							i_249652 = res_249654;
							F.line = 183;
							k_190832 = n_190169.attrs[chckIndx(i_249652, 0, n_190169.attrs.length+0-1)-0];
							F.line = 286;
							v_190833 = n_190169.attrs[chckIndx(addInt(i_249652, 1), 0, n_190169.attrs.length+0-1)-0];
							if (!((v_190833 == null))) {
							F.line = 185;
							...
							F.line = 2672;
							res_249654 = addInt(res_249654, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function same_190920(n_190922, e_190923, nesting_190924) {
	...
	BeforeRet: do {
		...
		L3: do {
			...
			var i_190994 = 0;
			F.line = 2716;
			var colontmp__249688 = 0;
			F.line = 207;
			colontmp__249688 = len_170742(n_190922);
			F.line = 2717;
			var i_249689 = 0;
			L4: do {
				F.line = 2718;
					L5: while (true) {
					if (!(i_249689 < colontmp__249688)) break L5;
						F.line = 207;
						i_190994 = i_249689;
...
function eq_56814(a_56816, b_56817) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_56916 = 0;
			F.line = 2716;
			var colontmp__249726 = 0;
			F.line = 233;
			colontmp__249726 = a_56816.length;
			F.line = 2717;
			var i_249727 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249727 < colontmp__249726)) break L3;
						F.line = 233;
						i_56916 = i_249727;
...
function same_attrs_172680(a_172682, b_172683) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_172707 = 0;
			F.line = 2716;
			var colontmp__249731 = 0;
			F.line = 291;
			colontmp__249731 = (a_172682.attrs != null ? a_172682.attrs.length : 0);
			F.line = 2717;
			var i_249732 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249732 < colontmp__249731)) break L3;
						F.line = 291;
						i_172707 = i_249732;
...
function eq_191214(a_191216, b_191217) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var i_192014 = 0;
			F.line = 2716;
			var colontmp__249721 = 0;
			F.line = 252;
			colontmp__249721 = len_170742(a_191216);
			F.line = 2717;
			var i_249722 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249722 < colontmp__249721)) break L3;
						F.line = 252;
						i_192014 = i_249722;
	...
	framePtr = F;
		...
		L1: do {
			...
			L2: do {
				...
				var i_249738 = 0;
				F.line = 2653;
				var colontmp__249739 = 0;
				F.line = 285;
				colontmp__249739 = subInt((old_node_192680.attrs != null ? old_node_192680.attrs.length : 0), 2);
				F.line = 2669;
				var res_249740 = 0;
				L3: do {
					F.line = 2670;
						L4: while (true) {
						if (!(res_249740 <= colontmp__249739)) break L4;
							F.line = 285;
							i_249738 = res_249740;
							F.line = 292;
							k_192689 = old_node_192680.attrs[chckIndx(i_249738, 0, old_node_192680.attrs.length+0-1)-0];
							F.line = 286;
							__192690 = old_node_192680.attrs[chckIndx(addInt(i_249738, 1), 0, old_node_192680.attrs.length+0-1)-0];
							F.line = 293;
							old_node_192680.dom.removeAttribute(k_192689);
							F.line = 2672;
							res_249740 = addInt(res_249740, 2);
						}
				} while(false);
			} while(false);
		} while(false);
		L5: do {
			...
			L6: do {
				...
				var i_249746 = 0;
				F.line = 2653;
				var colontmp__249747 = 0;
				F.line = 285;
				colontmp__249747 = subInt((new_node_192679.attrs != null ? new_node_192679.attrs.length : 0), 2);
				F.line = 2669;
				var res_249748 = 0;
				L7: do {
					F.line = 2670;
						L8: while (true) {
						if (!(res_249748 <= colontmp__249747)) break L8;
							F.line = 285;
							i_249746 = res_249748;
							F.line = 294;
							k_192691 = new_node_192679.attrs[chckIndx(i_249746, 0, new_node_192679.attrs.length+0-1)-0];
							F.line = 286;
							v_192692 = new_node_192679.attrs[chckIndx(addInt(i_249746, 1), 0, new_node_192679.attrs.length+0-1)-0];
							if (!((v_192692 == null))) {
							F.line = 296;
							...
							F.line = 2672;
							res_249748 = addInt(res_249748, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function merge_events_192706(new_node_192708, old_node_192709, kxi_192710) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_192724 = 0;
			F.line = 2716;
			var colontmp__249753 = 0;
			F.line = 301;
			colontmp__249753 = (old_node_192709.events != null ? old_node_192709.events.length : 0);
			F.line = 2717;
			var i_249754 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249754 < colontmp__249753)) break L3;
						F.line = 301;
						i_192724 = i_249754;
						F.line = 302;
...
function diff_193045(new_node_193047, old_node_193048, parent_193049, current_193050, kxi_193051) {
	...
	BeforeRet: do {
		...
		case 2:
			...
			F.line = 418;
			failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(418, 12) `oldNode.kind == newNode.kind` "));
			}
			...
			L4: do {
				F.line = 449;
					...
					if (!(common_prefix_193602 < min_length_193403)) break L5;
						...
						F.line = 427;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(427, 14) `commonPrefix <\x0A    newNode.len` "));
						}
						
						if (!((common_prefix_193602 < len_170742(old_node_193048)))) {
						F.line = 428;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(428, 14) `commonPrefix <\x0A    oldNode.len` "));
						}
			...
			L7: do {
				F.line = 456;
					L8: while (true) {
						...
						F.line = 427;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(427, 14) `newPos <\x0A    newNode.len` "));
						}
						
						if (!((old_pos_194022 < len_170742(old_node_193048)))) {
						F.line = 428;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(428, 14) `oldPos <\x0A    oldNode.len` "));
						}
			...
			L11: do {
				...
				var i_194440 = 0;
				F.line = 2679;
				var colontmp__249696 = 0;
				F.line = 463;
				colontmp__249696 = subInt(pos_194434, 1);
				F.line = 2689;
				var res_249697 = common_prefix_193602;
				L12: do {
					F.line = 2690;
						L13: while (true) {
						if (!(res_249697 <= colontmp__249696)) break L13;
							F.line = 463;
							i_194440 = res_249697;
							F.line = 464;
							...
							F.line = 2692;
							res_249697 = addInt(res_249697, 1);
						}
				} while(false);
			} while(false);
			...
			L14: do {
				...
				var i_194457 = 0;
				F.line = 2689;
				var res_249703 = pos_194434;
				L15: do {
					F.line = 2690;
						L16: while (true) {
						if (!(res_249703 <= new_pos_194023)) break L16;
							F.line = 474;
							i_194457 = res_249703;
							F.line = 475;
							...
							result_193052 = 4;
							F.line = 2692;
							res_249703 = addInt(res_249703, 1);
						}
				} while(false);
			} while(false);
			}
				...
				L17: do {
					...
					var i_194464 = 0;
					F.line = 2689;
					var res_249709 = pos_194434;
					L18: do {
						F.line = 2690;
							L19: while (true) {
							if (!(res_249709 <= new_pos_194023)) break L19;
								F.line = 479;
								i_194464 = res_249709;
								F.line = 480;
								...
								result_193052 = 4;
								F.line = 2692;
								res_249709 = addInt(res_249709, 1);
							}
					} while(false);
				} while(false);
			}
			...
			L20: do {
				...
				var i_194470 = 0;
				F.line = 2689;
				var res_249715 = pos_194434;
				L21: do {
					F.line = 2690;
						L22: while (true) {
						if (!(res_249715 <= old_pos_194022)) break L22;
							F.line = 483;
							i_194470 = res_249715;
							F.line = 484;
							...
							result_193052 = 4;
							F.line = 2692;
							res_249715 = addInt(res_249715, 1);
						}
				} while(false);
			} while(false);
			break;
		...
		case 4:
			if (true) {
			F.line = 491;
			failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(491, 26) `false` eq returned usenewNode"));
			}
			...
			F.line = 502;
				...
				if (!(i_194818 < (kxi_194816.components != null ? kxi_194816.components.length : 0))) break L2;
					...
					add_patch_192814(kxi_194816, 0, parent_195202, current_195201, x_194824.expanded);
						...
						F.line = 533;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(533, 18) `oldExpanded.dom != nil` old expanded.dom is nil"));
						}
							...
							F.line = 537;
							failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(537, 18) `x.expanded.dom != nil` expanded.dom is nil"));
							}
...
function apply_patch_192906(kxi_192908) {
	...
	framePtr = F;
		L1: do {
			...
			var i_192916 = 0;
			F.line = 2716;
			var colontmp__249761 = 0;
			F.line = 348;
			colontmp__249761 = kxi_192908.patchLen;
			F.line = 2717;
			var i_249762 = 0;
			L2: do {
				F.line = 2718;
					L3: while (true) {
					if (!(i_249762 < colontmp__249761)) break L3;
						F.line = 348;
						i_192916 = i_249762;
						F.line = 349;
		...
		L4: do {
			...
			var i_192960 = 0;
			F.line = 2716;
			var colontmp__249766 = 0;
			F.line = 374;
			colontmp__249766 = kxi_192908.patchLenV;
			F.line = 2717;
			var i_249767 = 0;
			L5: do {
				F.line = 2718;
					L6: while (true) {
					if (!(i_249767 < colontmp__249766)) break L6;
						F.line = 374;
						i_192960 = i_249767;
						F.line = 375;
						...
						F.line = 377;
						failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(377, 12) `p.newChild.dom != nil` "));
						}
						
						F.line = 2720;
						i_249767 = addInt(i_249767, 1);
					}
			} while(false);
		} while(false);
		F.line = 378;
...
function dodraw_197646(kxi_197648) {
	...
	BeforeRet: do {
		...
		replace_by_id_191012(kxi_197648.rootId, asdom_197669);
			...
			F.line = 597;
			failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(597, 14) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
			}
		...
		if (!(same_190920(kxi_197648.currentTree, document.getElementById(kxi_197648.rootId), 0))) {
		F.line = 611;
		failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\.nimble\\pkgs\\karax-1.1.0\\karax\\karax.nim(611, 12) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
		}
	...
	framePtr = F;
		...
		L1: do {
			...
			L2: do {
				F.line = 4;
					L3: while (true) {
					if (!(i_249791 < (kids_172250 != null ? kids_172250.length : 0))) break L3;
						F.line = 263;
						k_172282 = kids_172250[chckIndx(i_249791, 0, kids_172250.length+0-1)-0];
						F.line = 263;
						add_170800(result_172251, k_172282);
						F.line = 6;
						i_249791 = addInt(i_249791, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function balloon_class_249285() {
	var result_249287 = null;
	...
	BeforeRet: do {
		...
		F.line = 50;
		result_249287 = nimCopy(null, makeNimstrLit("nes-balloon from-left"), NTI138);
		break BeforeRet;
		}
		
		F.line = 51;
		result_249287 = nimCopy(null, makeNimstrLit("nes-balloon"), NTI138);
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249287;
	...
	BeforeRet: do {
		...
		n_170570.attrs = nimCopy(null, [key_170571, val_170572], NTI170587);
			...
			L1: do {
				...
				var i_170600 = 0;
				F.line = 2653;
				var colontmp__249796 = 0;
				F.line = 218;
				colontmp__249796 = subInt((n_170570.attrs != null ? n_170570.attrs.length : 0), 2);
				F.line = 2669;
				var res_249797 = 0;
				L2: do {
					F.line = 2670;
						L3: while (true) {
						if (!(res_249797 <= colontmp__249796)) break L3;
							F.line = 218;
							i_170600 = res_249797;
							...
							F.line = 2672;
							res_249797 = addInt(res_249797, 2);
						}
				} while(false);
			} while(false);
			F.line = 222;
...
function actions_249259() {
	var result_249261 = null;
	...
	BeforeRet: do {
		F.line = 44;
		F.line = 44;
		var tmp_249262 = tree_172246(43, []);
		F.line = 44;
		tmp_249262.class = "actions";
		F.line = 45;
		var tmp_249263 = tree_172246(44, []);
		F.line = 45;
		tmp_249263.class = "nes-btn";
		F.line = 45;
		set_attr_170568(tmp_249263, "href", "mailto:kidandcat@gmail.com");
		F.line = 46;
		add_170800(tmp_249263, text_172364(makeNimstrLit("Email Jairo")));
		F.line = 46;
		add_170800(tmp_249262, tmp_249263);
		result_249261 = tmp_249262;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249261;

}

function social_networks_249188() {
	var result_249190 = null;
	...
	BeforeRet: do {
		F.line = 31;
		F.line = 31;
		var tmp_249191 = tree_172246(43, []);
		F.line = 31;
		tmp_249191.class = "socials";
		F.line = 32;
		var tmp_249192 = tree_172246(44, []);
		F.line = 32;
		set_attr_170568(tmp_249192, "href", "https://twitter.com/kidandcat");
		F.line = 32;
		set_attr_170568(tmp_249192, "target", "_blank");
		F.line = 33;
		var tmp_249193 = tree_172246(61, []);
		F.line = 33;
		tmp_249193.class = "nes-icon twitter";
		F.line = 33;
		add_170800(tmp_249192, tmp_249193);
		F.line = 33;
		add_170800(tmp_249191, tmp_249192);
		F.line = 34;
		var tmp_249194 = tree_172246(44, []);
		F.line = 34;
		set_attr_170568(tmp_249194, "href", "https://github.com/kidandcat");
		F.line = 34;
		set_attr_170568(tmp_249194, "target", "_blank");
		F.line = 35;
		var tmp_249195 = tree_172246(61, []);
		F.line = 35;
		tmp_249195.class = "nes-icon github";
		F.line = 35;
		add_170800(tmp_249194, tmp_249195);
		F.line = 35;
		add_170800(tmp_249191, tmp_249194);
		F.line = 36;
		var tmp_249196 = tree_172246(44, []);
		F.line = 36;
		set_attr_170568(tmp_249196, "href", "https://linkedin.com/in/kidandcat");
		F.line = 36;
		set_attr_170568(tmp_249196, "target", "_blank");
		F.line = 37;
		var tmp_249197 = tree_172246(61, []);
		F.line = 37;
		tmp_249197.class = "nes-icon linkedin";
		F.line = 37;
		add_170800(tmp_249196, tmp_249197);
		F.line = 37;
		add_170800(tmp_249191, tmp_249196);
		F.line = 38;
		var tmp_249198 = tree_172246(44, []);
		F.line = 38;
		set_attr_170568(tmp_249198, "href", "https://www.youtube.com/user/interacso");
		F.line = 38;
		set_attr_170568(tmp_249198, "target", "_blank");
		F.line = 39;
		var tmp_249199 = tree_172246(61, []);
		F.line = 39;
		tmp_249199.class = "nes-icon youtube";
		F.line = 39;
		add_170800(tmp_249198, tmp_249199);
		F.line = 39;
		add_170800(tmp_249191, tmp_249198);
		F.line = 40;
		var tmp_249200 = tree_172246(44, []);
		F.line = 40;
		set_attr_170568(tmp_249200, "href", "https://keybase.io/kidandcat");
		F.line = 40;
		set_attr_170568(tmp_249200, "target", "_blank");
		F.line = 41;
		var tmp_249201 = tree_172246(75, []);
		F.line = 41;
		tmp_249201.class = "social-icon";
		F.line = 41;
		set_attr_170568(tmp_249201, "src", "keybase.png");
		F.line = 41;
		add_170800(tmp_249200, tmp_249201);
		F.line = 41;
		add_170800(tmp_249191, tmp_249200);
		result_249190 = tmp_249191;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249190;

}

function star_level_249014(pos_249016, level_249017) {
	var result_249018 = null;

	var F={procname:"index.starLevel",prev:framePtr,filename:"index.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		if ((pos_249016 <= level_249017)) {
		F.line = 5;
		result_249018 = nimCopy(null, [], NTI138);
		break BeforeRet;
		}
		
		F.line = 6;
		result_249018 = nimCopy(null, makeNimstrLit("is-empty"), NTI138);
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249018;

}

function skill_249119(name_249121, level_249122, love_249123) {
	var result_249124 = null;
	...
	BeforeRet: do {
		F.line = 17;
		F.line = 17;
		var tmp_249125 = tree_172246(44, []);
		F.line = 17;
		tmp_249125.class = "skill";
		F.line = 18;
		var tmp_249126 = tree_172246(43, []);
		if (love_249123) {
		F.line = 20;
		var tmp_249127 = tree_172246(70, []);
		F.line = 20;
		tmp_249127.class = "nes-icon heart love";
		F.line = 20;
		add_170800(tmp_249126, tmp_249127);
		}
		
		F.line = 21;
		var tmp_249128 = tree_172246(70, []);
		F.line = 21;
		tmp_249128.class = "skill-name";
		F.line = 22;
		add_170800(tmp_249128, text_172364(name_249121));
		F.line = 22;
		add_170800(tmp_249126, tmp_249128);
		F.line = 22;
		add_170800(tmp_249125, tmp_249126);
		F.line = 23;
		var tmp_249129 = tree_172246(43, []);
		F.line = 23;
		tmp_249129.class = "stars";
		F.line = 24;
		var tmp_249130 = tree_172246(70, []);
		F.line = 24;
		tmp_249130.class = toJSStr((makeNimstrLit("nes-icon star ") || []).concat(star_level_249014(1, level_249122) || []));
		F.line = 24;
		add_170800(tmp_249129, tmp_249130);
		F.line = 25;
		var tmp_249131 = tree_172246(70, []);
		F.line = 25;
		tmp_249131.class = toJSStr((makeNimstrLit("nes-icon star ") || []).concat(star_level_249014(2, level_249122) || []));
		F.line = 25;
		add_170800(tmp_249129, tmp_249131);
		F.line = 26;
		var tmp_249132 = tree_172246(70, []);
		F.line = 26;
		tmp_249132.class = toJSStr((makeNimstrLit("nes-icon star ") || []).concat(star_level_249014(3, level_249122) || []));
		F.line = 26;
		add_170800(tmp_249129, tmp_249132);
		F.line = 27;
		var tmp_249133 = tree_172246(70, []);
		F.line = 27;
		tmp_249133.class = toJSStr((makeNimstrLit("nes-icon star ") || []).concat(star_level_249014(4, level_249122) || []));
		F.line = 27;
		add_170800(tmp_249129, tmp_249133);
		F.line = 28;
		var tmp_249134 = tree_172246(70, []);
		F.line = 28;
		tmp_249134.class = toJSStr((makeNimstrLit("nes-icon star ") || []).concat(star_level_249014(5, level_249122) || []));
		F.line = 28;
		add_170800(tmp_249129, tmp_249134);
		F.line = 28;
		add_170800(tmp_249125, tmp_249129);
		result_249124 = tmp_249125;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249124;

}

function get_level_class_249318(kind_249320) {
	var result_249321 = null;

	var F={procname:"index.getLevelClass",prev:framePtr,filename:"index.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		if (eqStrings(kind_249320, makeNimstrLit("hard"))) {
		if (is_hard_249304[0]) {
		F.line = 58;
		result_249321 = nimCopy(null, makeNimstrLit("nes-btn is-error"), NTI138);
		break BeforeRet;
		}
		
		F.line = 59;
		result_249321 = nimCopy(null, makeNimstrLit("nes-btn"), NTI138);
		break BeforeRet;
		}
		
		if (eqStrings(kind_249320, makeNimstrLit("easy"))) {
		if (is_hard_249304[0]) {
		F.line = 62;
		result_249321 = nimCopy(null, makeNimstrLit("nes-btn"), NTI138);
		break BeforeRet;
		...
		F.line = 63;
		result_249321 = nimCopy(null, makeNimstrLit("nes-btn is-success"), NTI138);
		break BeforeRet;
		}
...
function level_249339() {

		function HEX3Aanonymous_249359(ev_249361, n_249362) {
			var F={procname:"level.:anonymous",prev:framePtr,filename:"index.nim",line:0};
			framePtr = F;
				F.line = 72;
				is_hard_249304[0] = false;
				L1: do {
					F.line = 73;
					var el_249414 = null;
					F.line = 183;
					var colontmp__249830 = null;
					F.line = 73;
					colontmp__249830 = document.querySelectorAll(".experience-text");
					F.line = 185;
					var i_249832 = 0;
					F.line = 186;
					var l_249833 = (colontmp__249830 != null ? colontmp__249830.length : 0);
					L2: do {
						F.line = 187;
							L3: while (true) {
							if (!(i_249832 < l_249833)) break L3;
								F.line = 73;
								el_249414 = colontmp__249830[chckIndx(i_249832, 0, colontmp__249830.length+0-1)-0];
								F.line = 74;
								el_249414.classList.add("easyfont");
								F.line = 189;
								i_249832 = addInt(i_249832, 1);
								if (!(((colontmp__249830 != null ? colontmp__249830.length : 0) == l_249833))) {
								F.line = 190;
								failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\scoop\\apps\\nim\\current\\lib\\system\\iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
		...
		function HEX3Aanonymous_249448(ev_249450, n_249451) {
			var F={procname:"level.:anonymous",prev:framePtr,filename:"index.nim",line:0};
			framePtr = F;
				F.line = 78;
				is_hard_249304[0] = true;
				L1: do {
					F.line = 79;
					var el_249458 = null;
					F.line = 183;
					var colontmp__249836 = null;
					F.line = 79;
					colontmp__249836 = document.querySelectorAll(".experience-text");
					F.line = 185;
					var i_249837 = 0;
					F.line = 186;
					var l_249838 = (colontmp__249836 != null ? colontmp__249836.length : 0);
					L2: do {
						F.line = 187;
							L3: while (true) {
							if (!(i_249837 < l_249838)) break L3;
								F.line = 79;
								el_249458 = colontmp__249836[chckIndx(i_249837, 0, colontmp__249836.length+0-1)-0];
								F.line = 80;
								el_249458.classList.remove("easyfont");
								F.line = 189;
								i_249837 = addInt(i_249837, 1);
								if (!(((colontmp__249836 != null ? colontmp__249836.length : 0) == l_249838))) {
								F.line = 190;
								failed_assert_impl_15051(makeNimstrLit("C:\\Users\\jairo\\scoop\\apps\\nim\\current\\lib\\system\\iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
	...
	BeforeRet: do {
		F.line = 66;
		F.line = 66;
		var tmp_249342 = tree_172246(43, []);
		F.line = 66;
		tmp_249342.class = "level";
		F.line = 67;
		var tmp_249343 = tree_172246(70, []);
		F.line = 68;
		add_170800(tmp_249343, text_172364(makeNimstrLit("Level: ")));
		F.line = 68;
		add_170800(tmp_249342, tmp_249343);
		F.line = 69;
		var tmp_249344 = tree_172246(106, []);
		F.line = 69;
		tmp_249344.class = toJSStr(get_level_class_249318(makeNimstrLit("easy")));
		F.line = 69;
		tmp_249344.id = "easy";
		F.line = 70;
		add_170800(tmp_249344, text_172364(makeNimstrLit("Easy")));
		F.line = 71;
		add_event_handler_199528(tmp_249344, 0, HEX3Aanonymous_249359, kxi_189324[0]);
		F.line = 71;
		add_170800(tmp_249342, tmp_249344);
		F.line = 75;
		var tmp_249345 = tree_172246(106, []);
		F.line = 75;
		tmp_249345.class = toJSStr(get_level_class_249318(makeNimstrLit("hard")));
		F.line = 75;
		tmp_249345.id = "hard";
		F.line = 76;
		add_170800(tmp_249345, text_172364(makeNimstrLit("Hard")));
		F.line = 77;
		add_event_handler_199528(tmp_249345, 0, HEX3Aanonymous_249448, kxi_189324[0]);
		F.line = 77;
		add_170800(tmp_249342, tmp_249345);
		result_249341 = tmp_249342;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249341;

}

function experience_249032(title_249034, desc_249036) {
	var result_249037 = null;
	...
	BeforeRet: do {
		F.line = 9;
		F.line = 9;
		var tmp_249080 = tree_172246(43, []);
		F.line = 9;
		tmp_249080.class = "nes-container with-title is-rounded experience";
		F.line = 10;
		var tmp_249086 = tree_172246(31, []);
		F.line = 10;
		tmp_249086.class = "title";
		F.line = 11;
		add_170800(tmp_249086, text_172364(title_249034));
		F.line = 11;
		add_170800(tmp_249080, tmp_249086);
		L1: do {
			F.line = 12;
			var d_249101 = null;
			F.line = 3;
			...
			L2: do {
				F.line = 4;
					L3: while (true) {
					if (!(i_249844 < (desc_249036 != null ? desc_249036.length : 0))) break L3;
						F.line = 12;
						d_249101 = desc_249036[chckIndx(i_249844, 0, desc_249036.length+0-1)-0];
						F.line = 13;
						var tmp_249087 = tree_172246(31, []);
						F.line = 13;
						tmp_249087.class = "experience-text";
						F.line = 14;
						add_170800(tmp_249087, text_172364(d_249101));
						F.line = 14;
						add_170800(tmp_249080, tmp_249087);
						F.line = 6;
						i_249844 = addInt(i_249844, 1);
					}
			} while(false);
		} while(false);
		result_249037 = tmp_249080;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249037;

}

function create_dom_249487() {
	var result_249489 = null;
	...
	BeforeRet: do {
		F.line = 83;
		F.line = 83;
		var tmp_249490 = tree_172246(43, []);
		F.line = 83;
		tmp_249490.class = "main";
		F.line = 84;
		var tmp_249491 = tree_172246(43, []);
		F.line = 84;
		tmp_249491.class = toJSStr(balloon_class_249285());
		F.line = 84;
		tmp_249491.id = "saying";
		F.line = 85;
		var tmp_249492 = tree_172246(31, []);
		F.line = 86;
		add_170800(tmp_249492, text_172364(makeNimstrLit("Welcome to my CV")));
		F.line = 86;
		add_170800(tmp_249491, tmp_249492);
		F.line = 86;
		add_170800(tmp_249490, tmp_249491);
		F.line = 87;
		var tmp_249493 = tree_172246(43, []);
		F.line = 87;
		tmp_249493.class = "avatar";
		F.line = 88;
		var tmp_249494 = tree_172246(75, []);
		F.line = 88;
		set_attr_170568(tmp_249494, "src", "avatar.jpg");
		F.line = 88;
		tmp_249494.id = "avatar-img";
		F.line = 88;
		tmp_249494.class = "nes-avatar is-large";
		F.line = 88;
		add_170800(tmp_249493, tmp_249494);
		F.line = 88;
		add_170800(tmp_249490, tmp_249493);
		F.line = 89;
		var tmp_249495 = tree_172246(43, []);
		F.line = 89;
		tmp_249495.class = "name";
		F.line = 90;
		var tmp_249496 = tree_172246(70, []);
		F.line = 91;
		add_170800(tmp_249496, text_172364(makeNimstrLit("Jairo Caro-Accino Viciana")));
		F.line = 91;
		add_170800(tmp_249495, tmp_249496);
		F.line = 91;
		add_170800(tmp_249490, tmp_249495);
		F.line = 92;
		add_170800(tmp_249490, actions_249259());
		F.line = 93;
		add_170800(tmp_249490, social_networks_249188());
		F.line = 94;
		var tmp_249497 = tree_172246(43, []);
		F.line = 94;
		tmp_249497.class = "working";
		F.line = 95;
		var tmp_249498 = tree_172246(44, []);
		F.line = 95;
		set_attr_170568(tmp_249498, "href", "https://github.com/Ridote/godotExperiments3D/tree/master/RPG-server");
		F.line = 95;
		set_attr_170568(tmp_249498, "target", "_blank");
		F.line = 96;
		add_170800(tmp_249498, text_172364(makeNimstrLit("Right now working on RPG-server")));
		F.line = 96;
		add_170800(tmp_249497, tmp_249498);
		F.line = 96;
		add_170800(tmp_249490, tmp_249497);
		F.line = 97;
		var tmp_249499 = tree_172246(43, []);
		F.line = 97;
		tmp_249499.class = "sections";
		F.line = 98;
		var tmp_249500 = tree_172246(43, []);
		F.line = 98;
		tmp_249500.class = "left";
		F.line = 99;
		var tmp_249501 = tree_172246(23, []);
		F.line = 100;
		var tmp_249502 = tree_172246(61, []);
		F.line = 100;
		tmp_249502.class = "nes-icon trophy";
		F.line = 100;
		add_170800(tmp_249501, tmp_249502);
		F.line = 101;
		add_170800(tmp_249501, text_172364(makeNimstrLit("Skills")));
		F.line = 101;
		add_170800(tmp_249500, tmp_249501);
		F.line = 102;
		var tmp_249503 = tree_172246(43, []);
		F.line = 102;
		tmp_249503.class = "badges";
		F.line = 103;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("react"), 5, false));
		F.line = 104;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("JS"), 5, false));
		F.line = 105;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Nim"), 2, true));
		F.line = 106;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Go"), 4, false));
		F.line = 107;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("CSS"), 4, false));
		F.line = 108;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("PHP"), 3, false));
		F.line = 109;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Windows"), 3, false));
		F.line = 110;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Mac"), 1, false));
		F.line = 111;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Linux"), 4, false));
		F.line = 112;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Networking"), 3, false));
		F.line = 113;
		add_170800(tmp_249503, skill_249119(makeNimstrLit("Security"), 3, false));
		F.line = 113;
		add_170800(tmp_249500, tmp_249503);
		F.line = 113;
		add_170800(tmp_249499, tmp_249500);
		F.line = 114;
		var tmp_249504 = tree_172246(43, []);
		F.line = 114;
		tmp_249504.class = "right";
		F.line = 115;
		var tmp_249505 = tree_172246(23, []);
		F.line = 116;
		var tmp_249506 = tree_172246(61, []);
		F.line = 116;
		tmp_249506.class = "nes-icon trophy";
		F.line = 116;
		add_170800(tmp_249505, tmp_249506);
		F.line = 117;
		add_170800(tmp_249505, text_172364(makeNimstrLit("Experience")));
		F.line = 117;
		add_170800(tmp_249504, tmp_249505);
		F.line = 118;
		add_170800(tmp_249504, level_249339());
		F.line = 127;
		add_170800(tmp_249504, experience_249032(makeNimstrLit("Netelip"), [makeNimstrLit("        Netelip was my first home, I had my intership there after I finished my latest studies, after 3 months of \x0A        intership I stayed there working, in total I spent there 1 year. My first job was to make a complex platform\x0A        to work, it was developed in symfony, but it was unusable due to the high latency (up to 5s to do any action)\x0A        in the frontend, the first thing I did was update to PHP7, just with that, it became much more responsive.\x0A        "), makeNimstrLit("        After that I introduced a real time monitoring system (which we watched on a big TV in the office), some services\x0A        connecting with Asterisk SIP using Janus Gateway, and a VPS service with NodeJS and Proxmox.\x0A        "), makeNimstrLit("        I learnt a lot in Netelip, but I was ambitious, and I wanted to experiment life outside of my city, so I moved to...\x0A        ")]));
		F.line = 139;
		add_170800(tmp_249504, experience_249032(makeNimstrLit("Indigitall"), [makeNimstrLit("        Indigitall is a startup located in Madrid, the company focused on its Push Notifications As a Service, again, my job was\x0A        to maintain and upgrade the backend they had in PHP, Symfony toom and I managed the servers too.\x0A        "), makeNimstrLit("        What I learnt the most here was to interact with clients. Because we where just 3 people, and we had big clients, I\x0A        had to email with clients, go to their offices, etc.\x0A        "), makeNimstrLit("        We had some interesting performance challenges, when Orange became a client, we instantly had 2 to send push notifications\x0A        to two million users, that was fun.\x0A        "), makeNimstrLit("        Although I was very happy here, I was not happy with the lifestyle in Madrid, and our house was too small, and the big distances!\x0A        Finally a chance to come back to M\xC3\xA1laga knocked my door, and in less than 2 weeks, I was back in M\xC3\xA1laga.\x0A        ")]));
		F.line = 151;
		add_170800(tmp_249504, experience_249032(makeNimstrLit("Accenture"), [makeNimstrLit("        My next adventure was in Accenture, this time I was contracted as Frontend Developer with React experience. I was happy to be\x0A        able to experience working in a big company. I learnt what bureaucracy is, big offices, a lot of people, and very big development\x0A        teams. It was interesting, I received a very good course from lemoncode.net about React + Redux-Observables. But once again, it was\x0A        not what I was looking for.\x0A        "), makeNimstrLit("        In a short time, few months, I saw myself wasting my time, spending hours and hours doing non-sense burocracy and I was not learning\x0A        anything new (at least programming related, I keep learning a lot of things about the company itself).\x0A        "), makeNimstrLit("        Finally, most of my mates leaved, and I did it too. Being in M\xC3\xA1laga again, there where a lot of possibilities near me.\x0A        ")]));
		F.line = 161;
		add_170800(tmp_249504, experience_249032(makeNimstrLit("Algorath"), [makeNimstrLit("        Algorath was a startup with just 3 people, placed next to the university of M\xC3\xA1laga. I worked here coding mainly in Go. It was my first \x0A        experience working with Go with an experienced team.\x0A        "), makeNimstrLit("        We worked together with an england company, Yoti, developing a distributed ledger to manage identities. I learnt a lot about Go and\x0A        well practices thanks to very good and experienced people [thanks Piers ;)]. After a few months I was in charge of developing a\x0A        mobile app using Go Mobile + React Native, we managed to launch a node of the ledger inside the phone.\x0A        "), makeNimstrLit("        My experience in Algorath was very confortable, and I learnt a lot. I\'m grateful for the time I spent there. But finally, one more chance\x0A        came to me. The chance of remote working...\x0A        ")]));
		F.line = 172;
		add_170800(tmp_249504, experience_249032(makeNimstrLit("Interacso"), [makeNimstrLit("        Interacso is my current company, I\'ve been working here for a full year now (that\'s a new thing to me). I closed the contract and start \x0A        working remotely without even visiting my company office. After few months, I went to Madrid to meet my mates in person.\x0A        "), makeNimstrLit("        Here in Interacso I develop mostly frontend with React, any kind of frontend. Mobile apps, desktop apps, browser apps, and even IoT apps. \x0A        I have tons of challenges nearly every week. I have awesome mates and leaders. And also to be able to live\x0A        anywhere I want, and to manage my time are things I will have it hard to say goodbay to.\x0A        "), makeNimstrLit("        I\'m so happy in Interacso that this year has passed very quickly to me.\x0A        ")]));
		F.line = 172;
		add_170800(tmp_249499, tmp_249504);
		F.line = 172;
		add_170800(tmp_249490, tmp_249499);
		F.line = 175;
		var tmp_249507 = tree_172246(28, []);
		F.line = 176;
		add_170800(tmp_249507, text_172364(makeNimstrLit("This website has been made with ")));
		F.line = 177;
		var tmp_249508 = tree_172246(75, []);
		F.line = 177;
		set_attr_170568(tmp_249508, "src", "nim.png");
		F.line = 177;
		add_170800(tmp_249507, tmp_249508);
		F.line = 177;
		add_170800(tmp_249490, tmp_249507);
		result_249489 = tmp_249490;
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_249489;

}

function add_stylesheet_248075(href_248077) {
	var F={procname:"jsutils.addStylesheet",prev:framePtr,filename:"jsutils.nim",line:0};
	framePtr = F;
		F.line = 17;
		var css_248078 = document.createElement("link");
		F.line = 18;
		css_248078.setAttribute("href", toJSStr(href_248077));
		F.line = 19;
		css_248078.setAttribute("rel", "stylesheet");
		F.line = 20;
		document.head.appendChild(css_248078);
	framePtr = F.prev;

	
}
set_renderer_199383(create_dom_249487, "ROOT", null);
add_stylesheet_248075(makeNimstrLit("https://unpkg.com/nes.css@latest/css/nes.min.css"));
add_stylesheet_248075(makeNimstrLit("https://fonts.googleapis.com/css?family=Press+Start+2P&display=swap"));
add_stylesheet_248075(makeNimstrLit("style.css"));
